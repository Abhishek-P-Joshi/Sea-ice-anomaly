...
#define x 63
#define y 63
int t = 312, landmissingcount = 0;//x-number of rows, y-number of columns, t-no of weeks. Right now, initialized to small data set.
int degree[63][63];
int node[63][63];
int node1d[3969];
...
int main()
{
	...
	degreewrite.open("degreefor0956y.txt", ios::app | ios::out);
